...
Llmcode supports [using a pair of models for coding](https://llmcode.khulnasoft.com/2024/09/26/architect.html):
...
Once you [install llmcode](https://llmcode.khulnasoft.com/docs/install.html),
