...
[llmcode's model settings](https://llm.khulnasoft.com/docs/config/adv-model-settings.html#model-settings).
...
See [Advanced model settings](https://llm.khulnasoft.com/docs/config/adv-model-settings.html#model-settings) for details about all llmcode model settings
