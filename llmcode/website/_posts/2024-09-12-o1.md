...
# OpenAI o1-preview is SOTA on the llmcode leaderboard
...
OpenAI o1-preview scored 79.7% on llmcode's code editing benchmark,
...
It is much more practical to use llmcode's
...
The o1-preview model had trouble conforming to llmcode's diff edit format.
...
## Using llmcode with o1

OpenAI's new o1 models are supported in v0.57.0 of llmcode:
...
> See the [llmcode leaderboards](/docs/leaderboards/) for up-to-date results
> based on the latest llmcode releases.
