...
{: .note :}
This old
[llmcode code editing leaderboard](edit.html)
has been replaced by the
new, much more challenging
[polyglot leaderboard](/docs/leaderboards/).

[Llmcode's code editing benchmark](/docs/benchmarks.html#the-benchmark) asks the LLM to edit python source files to complete 133 small coding exercises
from Exercism. 
...
files = [
    ...
    'llmcode/website/_data/edit_leaderboard.yml',
]
