...
# Llmcode LLM Leaderboards

Llmcode works best with LLMs which are good at *editing* code, not just good at writing
code.
To evaluate an LLM's editing skill, llmcode uses benchmarks that
...
While [llmcode can connect to almost any LLM](/docs/llms.html),
it works best with models that score well on the benchmarks.


{: .note :}
The
[original llmcode code editing leaderboard](edit.html)
has been replaced by this 
new, much more challenging
[polyglot leaderboard](https://llmcode.khulnasoft.com/2024/12/21/polyglot.html).

## Polyglot leaderboard

[Llmcode's polyglot benchmark](/docs/benchmarks.html#the-benchmark) 
...
### Llmcode polyglot benchmark results
...
files = [
    ...
    'llmcode/website/_data/polyglot_leaderboard.yml',
]
