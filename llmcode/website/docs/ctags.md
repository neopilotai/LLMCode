...
[using tree-sitter to build a better repo map](https://llm.khulnasoft.com/docs/repomap.html).
...
[chat transcript](https://llm.khulnasoft.com/examples/add-test.html)
...
To code with GPT-4 using the techniques discussed here:
  ...
  - Install [llmcode](https://llm.khulnasoft.com/docs/install.html).
