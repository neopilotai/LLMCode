...
The
[whole](https://github.com/KhulnaSoft/llmcode/blob/main/llmcode/coders/wholefile_prompts.py)
...
The [diff](https://github.com/KhulnaSoft/llmcode/blob/main/llmcode/coders/editblock_prompts.py)
