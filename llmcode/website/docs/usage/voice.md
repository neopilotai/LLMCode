...
parent: Usage
nav_order: 100
description: Speak with llmcode about your code!
---

# Voice-to-code with llmcode

Speak with llmcode about your code! Request new features, test cases or bug fixes using your voice and let llmcode do the work of editing the files in your local git repo. As with all of llmcode's capabilities, you can use voice-to-code with an existing repo or to start a new project.

Voice support fits quite naturally into llmcode's AI pair programming
chat interface. Now you can fluidly switch between voice and text chat
when you ask llmcode to edit your code.
...
> Commit ef9e3e7 llmcode: Add a factorial endpoint that uses math.factorial.  
