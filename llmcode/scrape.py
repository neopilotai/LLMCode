...
from llmcode import __version__, urls, utils
from llmcode.dump import dump  # noqa: F401

llmcode_user_agent = f"Llmcode/{__version__} +{urls.website}"
...
class Scraper:
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({llmcode_user_agent})"}
        try:
            with httpx.Client(
