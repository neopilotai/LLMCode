...
def start_openrouter_oauth_flow(io, analytics):
    ...
    callback_url = f"http://localhost:{port}/callback/llmcode"
    auth_code = None
    server_error = None
    ...
    class OAuthCallbackHandler(http.server.SimpleHTTPRequestHandler):
        def do_GET(self):
            ...
            if parsed_path.path == "/callback/llmcode":
                ...
                if "code" in query_params:
                    ...
                    self.wfile.write(
                        ...
                        b"<p>Llmcode has received the authentication code. "
                    ...
                    # Redirect to llmcode website if 'code' is missing (e.g., user visited manually)
    ...
    if api_key:
        ...
        try:
            config_dir = os.path.expanduser("~/.llmcode")
