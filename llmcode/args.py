...
def get_parser(default_config_files, git_root):
    ...
    default_chat_history_file = (
        os.path.join(git_root, ".llmcode.khulnasoft.com.history.md")
        if git_root
        else ".llmcode.khulnasoft.com.history.md"
    )
    group.add_argument(
        "--input-history-file",
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute llmcode code changes in the git author name (default: True)",
    )
    group.add_argument(
        "--attribute-committer",
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute llmcode commits in the git committer name (default: True)",
    )
    group.add_argument(
