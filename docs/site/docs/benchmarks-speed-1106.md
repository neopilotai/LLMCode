...
excerpt: This report provides a detailed comparison of the speed of GPT-4 Turbo and gpt-3.5-turbo-1106 models based on the llmcode benchmarking suite.
canonical_url: https://llmcode.khulnasoft.com/2023/11/06/benchmarks-speed-1106.html
...
[![benchmark results](/assets/benchmarks-speed-1106.svg)](https://llmcode.khulnasoft.com/assets/benchmarks-speed-1106.svg)
...
Llmcode relies on a
[code editing benchmark](https://llmcode.khulnasoft.com/docs/benchmarks.html)
...
reports to get more background on llmcode's benchmark suite:
...
- [Code editing skill benchmarks for OpenAI's "1106" models](https://llmcode.khulnasoft.com/docs/benchmarks-1106.html) compares the olders models to the November (1106) models.

## Speed

This report compares the **speed** of the various GPT models.
Llmcode's benchmark measures the response time of the OpenAI chat completion
