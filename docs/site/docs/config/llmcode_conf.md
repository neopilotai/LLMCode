...
nav_order: 15
description: How to configure llmcode with a yaml config file.
---

# YAML config file

Most of llmcode's options can be set in an `.llmcode.conf.yml` file.
Llmcode will look for a this file in these locations:
...
can also
[download from GitHub](https://github.com/KhulnaSoft/llmcode/blob/main/docs/site/assets/sample.llmcode.conf.yml).

<!--[[[cog
from llmcode.args import get_sample_yaml
from pathlib import Path
text=get_sample_yaml()
Path("docs/site/assets/sample.llmcode.conf.yml").write_text(text)
cog.outl("```")
cog.out(text)
cog.outl("```")
]]]-->
...
#model-settings-file: .llmcode.model.settings.yml

## Specify a file with context window and costs for unknown models
#model-metadata-file: .llmcode.model.metadata.json
...
#input-history-file: .llmcode.input.history

## Specify the chat history file (default: .llmcode.khulnasoft.com.history.md)
#chat-history-file: .llmcode.khulnasoft.com.history.md
