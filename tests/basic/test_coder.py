...
"""
    ...
    def test_skip_llmcodeignored_files(self):
        with GitTemporaryDirectory():
            repo = git.Repo()
...
This command will print 'Hello, World!' to the console."""
    ...
    def test_normalize_language(self):
        ...
        with patch("llmcode.coders.base_coder.Locale", None):
        ...
        with patch("llmcode.coders.base_coder.Locale", mock_babel_locale):
        ...
        with patch("llmcode.coders.base_coder.Locale", mock_babel_locale_error):
    ...
    def test_architect_coder_auto_accept_true(self):
        with GitTemporaryDirectory():
            ...
            with patch("llmcode.coders.architect_coder.AskCoder.__init__", return_value=None):
                from llmcode.coders.architect_coder import ArchitectCoder
