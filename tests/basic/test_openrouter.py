...
from llmcode.models import ModelInfoManager
...
def test_model_info_manager_uses_openrouter_manager(monkeypatch):
    ...
    monkeypatch.setattr("llmcode.models.litellm.get_model_info", lambda *a, **k: {})
    ...
    monkeypatch.setattr(
        "llmcode.models.OpenRouterModelManager.get_model_info",
